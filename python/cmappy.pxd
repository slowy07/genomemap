...
cdef extern from "minimap.h":
    ...
    mm_idx_reader_t *mm_idx_reader_open(const chaar *fn, const mm_idxopt_t *opt, const char *fn_out)
    ...
    void mm_tbuf_destory(mm_tbuf_t *b)
    void *mm_tbuf_get_km(mm_tbuf_t *b)
    int mm_gen_cs(void *km, char **buf, int *max_len, const mm_idx_t *mi, const mm_reg_t *r, const char *seq, int no_iden)
